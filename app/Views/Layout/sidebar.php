    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?= (uri_string() == 'ruang') ? 'hover show' : ''; ?>">
                    <!--begin:Menu link-->
                    ...
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                    <div class="menu-sub menu-sub-accordion" style="<?= (uri_string() == 'ruang') ? '' : 'display: none; overflow: hidden;'; ?>">
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link <?= (uri_string() == 'ruang') ? 'active' : ''; ?>" href="<?= base_url('ruang'); ?>">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="../../demo1/dist/widgets/tables.html">
                                ...
                                <span class="menu-title">Urut</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
